...
const LeftArrow2 = () => {
  ...
  const closeLeftSlide = () => {
    dispatch(processDescriptionActions.close());
  }

  return (
    <div onClick={closeLeftSlide} className="left-arrow2">
      <svg style={{height: height + "px"}} ref={ref} version="1.1" className="left-arrow2-icon" x="0px" y="0px" viewBox="0 0 492 492">
        <g>
