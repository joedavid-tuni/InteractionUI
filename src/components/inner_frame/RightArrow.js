...
const RightArrow = () => {
  ...
  return ( 
    <div style={isOpen ? {fill: "rgba(255,255,255,0.0)"} : {}}
    onClick={openRightSlide} className="right-arrow">
      <svg style={{height: height + "px"}} ref={ref} version="1.1" className="right-arrow-icon" x="0px" y="0px" viewBox="0 0 492 492">
        <g>
