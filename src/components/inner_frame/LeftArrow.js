...
const LeftArrow = () => {
  ...
  return (
    <div style={isOpen ? {fill: "rgba(255,255,255,0.0)"} : {}} onClick={openLeftSlide} className='left-arrow'>
      <svg style={{height: height + "px"}} ref={ref} version="1.1" className="left-arrow-icon" x="0px" y="0px"
